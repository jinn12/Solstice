...
@Component
public class RivalVO implements Serializable{
	...
	public RivalVO(int com_seq, String com_biz_no, String com_company_name, String kipo_no_list, String com_reg_no,
	...
	public String toString() {
		return "RivalVO [com_seq=" + com_seq + ", com_biz_no=" + com_biz_no + ", com_company_name=" + com_company_name
