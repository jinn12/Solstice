...
<body>
     ...
     <span style="font-size: 18px; border-left: 2px solid #568DA6; text-align: left; color: #568DA6; padding-left: 12px; margin-left: 12px;font-weight: bold;letter-spacing: -1px;">관리자 시스템</span>
     </div>
